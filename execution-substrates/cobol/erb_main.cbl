       ...
       *> Run: ./erb_main < erb_input.tsv > erb_output.tsv
       ...
       01 WS-REC.
          ...
          02 WS-REC-COUNT-OF-STEPS PIC 9(10).
       ...
       *> Level 1
       ...
       WRITE-OUTPUT.
           ...
           STRING
               FUNCTION TRIM(WS-REC-WORKFLOW-ID TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-DISPLAY-NAME TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-TITLE TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-DESCRIPTION TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-IDENTIFIER TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-MODIFIED TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-WORKFLOW-STEPS TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-COUNT-OF-STEPS TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-NAME TRAILING) DELIMITED SIZE
               WS-TAB DELIMITED SIZE
               FUNCTION TRIM(WS-REC-HAS-MORE-THAN1-STEP TRAILING) DELIMITED SIZE
               INTO OUTPUT-LINE
